...
Friction coefficient & $\mu$ & 0.787 & Tested \\
Front tire stiffness & $C_{S_f}$ & 2.804 & Tested \\
Rear tire stiffness & $C_{S_r}$ & 3.320 & Tested \\
Max steering angle & $\delta_{\max}$ & \SI{0.4189}{\radian} & Calibrated \\
...
\begin{enumerate}
  ...
  \item \textbf{Pacejka tire model} --- non-linear $F_y(\alpha)$ with shape parameter $C = 1.9$ and $\mu = 0.787$.
