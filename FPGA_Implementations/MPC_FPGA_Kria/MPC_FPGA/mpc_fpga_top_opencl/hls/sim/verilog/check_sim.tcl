...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mpc_fpga_top_opencl.autotvin_gmem0.dat"
         "c.mpc_fpga_top_opencl.autotvin_input_words512.dat"
         "c.mpc_fpga_top_opencl.autotvin_output_words128.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mpc_fpga_top_opencl.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
