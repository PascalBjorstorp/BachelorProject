...
if {[file isfile mpc_fpga_top_opencl.autotvin.dat]} {
	file delete -force mpc_fpga_top_opencl.autotvin.dat
}

if {[file isfile mpc_fpga_top_opencl.autotvout.dat]} {
	file delete -force mpc_fpga_top_opencl.autotvout.dat
}
