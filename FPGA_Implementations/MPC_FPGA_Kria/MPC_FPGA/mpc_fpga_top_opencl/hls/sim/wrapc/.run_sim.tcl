...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/akselmo/Vivado_program/2025.2/Vitis/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc run_exec {fileExe} {
	...
	set ap_argv {/home/akselmo/Documents/GitHub/BachelorProject/tools/output/deep_diag_run1/frenet_parity/state_replay.csv 10}
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mpc_fpga_top_opencl.autotvin.dat"
	set constFileTvOut       "mpc_fpga_top_opencl.autotvout.dat"
	set constFileHdlTvIn     "mpc_fpga_top_opencl.autohdltvin.dat"
	set constFileHdlTvOut    "mpc_fpga_top_opencl.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
