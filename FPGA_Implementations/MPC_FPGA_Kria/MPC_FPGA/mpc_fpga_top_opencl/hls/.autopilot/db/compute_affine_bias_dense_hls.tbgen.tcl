...
dict set ap_memory_interface_dict sd_1 { MEM_WIDTH 32 MEM_SIZE 480 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO bus READ_LATENCY 0 }
set C_modelArgList {
	...
	{ lin_ey int 32 regular  }
	{ lin_epsi int 32 regular  }
	{ lin_vx int 32 regular  }
	{ lin_vy int 32 regular  }
	{ lin_omega int 32 regular  }
	{ lin_delta int 32 regular  }
	{ uk0 int 32 regular  }
	{ uk1 int 32 regular  }
	{ lin_delta_k int 32 regular  }
	{ next_ey int 32 regular  }
	{ next_epsi int 32 regular  }
	{ next_vx int 32 regular  }
	{ next_vy int 32 regular  }
	{ next_omega int 32 regular  }
	{ next_delta int 32 regular  }
	{ sd_1 int 32 regular {array 120 { 3 0 } 0 1 bus  }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "lin_ey", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_epsi", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_vx", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_vy", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_omega", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_delta", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "uk0", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "uk1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "lin_delta_k", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_ey", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_epsi", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_vx", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_vy", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_omega", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "next_delta", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sd_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ lin_ey sc_in sc_lv 32 signal 35 } 
	{ lin_epsi sc_in sc_lv 32 signal 36 } 
	{ lin_vx sc_in sc_lv 32 signal 37 } 
	{ lin_vy sc_in sc_lv 32 signal 38 } 
	{ lin_omega sc_in sc_lv 32 signal 39 } 
	{ lin_delta sc_in sc_lv 32 signal 40 } 
	{ uk0 sc_in sc_lv 32 signal 41 } 
	{ uk1 sc_in sc_lv 32 signal 42 } 
	{ lin_delta_k sc_in sc_lv 32 signal 43 } 
	{ next_ey sc_in sc_lv 32 signal 44 } 
	{ next_epsi sc_in sc_lv 32 signal 45 } 
	{ next_vx sc_in sc_lv 32 signal 46 } 
	{ next_vy sc_in sc_lv 32 signal 47 } 
	{ next_omega sc_in sc_lv 32 signal 48 } 
	{ next_delta sc_in sc_lv 32 signal 49 } 
	{ sd_1_address1 sc_out sc_lv 7 signal 50 } 
	{ sd_1_ce1 sc_out sc_logic 1 signal 50 } 
	{ sd_1_we1 sc_out sc_logic 1 signal 50 } 
	{ sd_1_d1 sc_out sc_lv 32 signal 50 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lin_ey", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_ey", "role": "default" }} , 
 	{ "name": "lin_epsi", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_epsi", "role": "default" }} , 
 	{ "name": "lin_vx", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_vx", "role": "default" }} , 
 	{ "name": "lin_vy", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_vy", "role": "default" }} , 
 	{ "name": "lin_omega", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_omega", "role": "default" }} , 
 	{ "name": "lin_delta", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_delta", "role": "default" }} , 
 	{ "name": "uk0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "uk0", "role": "default" }} , 
 	{ "name": "uk1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "uk1", "role": "default" }} , 
 	{ "name": "lin_delta_k", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "lin_delta_k", "role": "default" }} , 
 	{ "name": "next_ey", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_ey", "role": "default" }} , 
 	{ "name": "next_epsi", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_epsi", "role": "default" }} , 
 	{ "name": "next_vx", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_vx", "role": "default" }} , 
 	{ "name": "next_vy", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_vy", "role": "default" }} , 
 	{ "name": "next_omega", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_omega", "role": "default" }} , 
 	{ "name": "next_delta", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "next_delta", "role": "default" }} , 
 	...
 	{ "name": "sd_1_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sd_1", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	...
	lin_ey { ap_none {  { lin_ey in_data 0 32 } } }
	lin_epsi { ap_none {  { lin_epsi in_data 0 32 } } }
	lin_vx { ap_none {  { lin_vx in_data 0 32 } } }
	lin_vy { ap_none {  { lin_vy in_data 0 32 } } }
	lin_omega { ap_none {  { lin_omega in_data 0 32 } } }
	lin_delta { ap_none {  { lin_delta in_data 0 32 } } }
	uk0 { ap_none {  { uk0 in_data 0 32 } } }
	uk1 { ap_none {  { uk1 in_data 0 32 } } }
	lin_delta_k { ap_none {  { lin_delta_k in_data 0 32 } } }
	next_ey { ap_none {  { next_ey in_data 0 32 } } }
	next_epsi { ap_none {  { next_epsi in_data 0 32 } } }
	next_vx { ap_none {  { next_vx in_data 0 32 } } }
	next_vy { ap_none {  { next_vy in_data 0 32 } } }
	next_omega { ap_none {  { next_omega in_data 0 32 } } }
	next_delta { ap_none {  { next_delta in_data 0 32 } } }
	sd_1 { ap_memory {  { sd_1_address1 MemPortADDR2 1 7 }  { sd_1_ce1 MemPortCE2 1 1 }  { sd_1_we1 MemPortWE2 1 1 }  { sd_1_d1 MemPortDIN2 1 32 } } }
