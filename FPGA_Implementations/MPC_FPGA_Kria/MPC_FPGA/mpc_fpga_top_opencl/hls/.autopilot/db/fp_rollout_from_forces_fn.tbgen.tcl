...
set C_modelArgList {
	...
	{ F_yf int 26 regular  }
	{ F_yr int 26 regular  }
	{ sin_delta int 26 regular  }
	{ cos_delta int 26 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "ey", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "vx_safe", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "Fx", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "F_yf", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "F_yr", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "sin_delta", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "cos_delta", "interface" : "wire", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sin_epsi sc_in sc_lv 26 signal 2 } 
	{ cos_epsi sc_in sc_lv 26 signal 3 } 
	{ vx_safe sc_in sc_lv 26 signal 4 } 
	{ vy sc_in sc_lv 26 signal 5 } 
	{ omega sc_in sc_lv 26 signal 6 } 
	{ kappa sc_in sc_lv 26 signal 7 } 
	{ Fx sc_in sc_lv 26 signal 8 } 
	{ F_yf sc_in sc_lv 26 signal 9 } 
	{ F_yr sc_in sc_lv 26 signal 10 } 
	{ sin_delta sc_in sc_lv 26 signal 11 } 
	{ cos_delta sc_in sc_lv 26 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vx_safe", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "vx_safe", "role": "default" }} , 
 	...
 	{ "name": "Fx", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "Fx", "role": "default" }} , 
 	{ "name": "F_yf", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "F_yf", "role": "default" }} , 
 	{ "name": "F_yr", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "F_yr", "role": "default" }} , 
 	{ "name": "sin_delta", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "sin_delta", "role": "default" }} , 
 	{ "name": "cos_delta", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "cos_delta", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	vx_safe { ap_none {  { vx_safe in_data 0 26 } } }
	vy { ap_none {  { vy in_data 0 26 } } }
	omega { ap_none {  { omega in_data 0 26 } } }
	kappa { ap_none {  { kappa in_data 0 26 } } }
	Fx { ap_none {  { Fx in_data 0 26 } } }
	F_yf { ap_none {  { F_yf in_data 0 26 } } }
	F_yr { ap_none {  { F_yr in_data 0 26 } } }
	sin_delta { ap_none {  { sin_delta in_data 0 26 } } }
	cos_delta { ap_none {  { cos_delta in_data 0 26 } } }
}
