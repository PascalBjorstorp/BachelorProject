set moduleName mpc_compute_hls_Pipeline_VITIS_LOOP_1320_16
set isTopModule 0
...
set cdfgNum 74
set C_modelName {mpc_compute_hls_Pipeline_VITIS_LOOP_1320_16}
...
dict set ap_memory_interface_dict z_x { MEM_WIDTH 26 MEM_SIZE 84 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO bus READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ z_x int 26 regular {array 21 { 1 3 } 1 1 bus  }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "y_x_5", "interface" : "memory", "bitwidth" : 26, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "z_x", "interface" : "memory", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	...
	z_x { ap_memory {  { z_x_address0 mem_address 1 5 }  { z_x_ce0 mem_ce 1 1 }  { z_x_q0 mem_dout 0 26 } } }
