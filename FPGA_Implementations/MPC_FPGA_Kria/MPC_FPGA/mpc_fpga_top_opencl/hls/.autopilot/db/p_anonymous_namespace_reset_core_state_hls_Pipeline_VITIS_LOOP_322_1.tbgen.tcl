set moduleName p_anonymous_namespace_reset_core_state_hls_Pipeline_VITIS_LOOP_322_1
set isTopModule 0
...
set cdfgNum 74
set C_modelName {(anonymous namespace)reset_core_state_hls_Pipeline_VITIS_LOOP_322_1}
