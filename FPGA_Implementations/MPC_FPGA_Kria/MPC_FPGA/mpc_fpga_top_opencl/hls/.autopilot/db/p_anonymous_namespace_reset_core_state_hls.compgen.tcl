...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_anonymous_namespace_g_core_state_admm_initialized { O 1 vector } p_anonymous_namespace_g_core_state_admm_initialized_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_anonymous_namespace_g_core_state_persist_actual_steering { O 32 vector } p_anonymous_namespace_g_core_state_persist_actual_steering_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 109 \
    name p_anonymous_namespace_g_core_state_persist_max_iter_streak \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_p_anonymous_namespace_g_core_state_persist_max_iter_streak \
    op interface \
    ports { p_anonymous_namespace_g_core_state_persist_max_iter_streak { O 32 vector } p_anonymous_namespace_g_core_state_persist_max_iter_streak_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 110 \
    name p_anonymous_namespace_g_core_state_initialized \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_p_anonymous_namespace_g_core_state_initialized \
    op interface \
    ports { p_anonymous_namespace_g_core_state_initialized { O 1 vector } p_anonymous_namespace_g_core_state_initialized_ap_vld { O 1 bit } } \
} "
}
