...
set C_modelArgList {
	{ rear_ratio int 21 regular  }
	{ D_transfer int 21 regular  }
	{ D_pac_r int 21 regular  }
	{ C_min_r int 21 regular  }
	{ rear_num int 21 regular  }
	{ vx_safe int 20 regular  }
	{ D_r_fn int 21 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rear_ratio", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "D_transfer", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "D_pac_r", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "C_min_r", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "rear_num", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	{ "Name" : "vx_safe", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
 	{ "Name" : "D_r_fn", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rear_ratio sc_in sc_lv 21 signal 0 } 
	{ D_transfer sc_in sc_lv 21 signal 1 } 
	{ D_pac_r sc_in sc_lv 21 signal 2 } 
	{ C_min_r sc_in sc_lv 21 signal 3 } 
	{ rear_num sc_in sc_lv 21 signal 4 } 
	{ vx_safe sc_in sc_lv 20 signal 5 } 
	{ D_r_fn sc_in sc_lv 21 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rear_ratio", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "rear_ratio", "role": "default" }} , 
 	{ "name": "D_transfer", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "D_transfer", "role": "default" }} , 
 	{ "name": "D_pac_r", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "D_pac_r", "role": "default" }} , 
 	{ "name": "C_min_r", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "C_min_r", "role": "default" }} , 
 	{ "name": "rear_num", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "rear_num", "role": "default" }} , 
 	{ "name": "vx_safe", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "vx_safe", "role": "default" }} , 
 	{ "name": "D_r_fn", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "D_r_fn", "role": "default" }} , 
...
set Spec2ImplPortList { 
	rear_ratio { ap_none {  { rear_ratio in_data 0 21 } } }
	D_transfer { ap_none {  { D_transfer in_data 0 21 } } }
	D_pac_r { ap_none {  { D_pac_r in_data 0 21 } } }
	C_min_r { ap_none {  { C_min_r in_data 0 21 } } }
	rear_num { ap_none {  { rear_num in_data 0 21 } } }
	vx_safe { ap_none {  { vx_safe in_data 0 20 } } }
	D_r_fn { ap_none {  { D_r_fn in_data 0 21 } } }
