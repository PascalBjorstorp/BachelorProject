...
set C_modelArgMapList {[ 
	{ "Name" : "vy", "interface" : "wire", "bitwidth" : 21, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "inv_vx", "interface" : "wire", "bitwidth" : 20, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ vy sc_in sc_lv 21 signal 0 } 
	{ omega sc_in sc_lv 21 signal 1 } 
	{ inv_vx sc_in sc_lv 20 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inv_vx", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "inv_vx", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	inv_vx { ap_none {  { inv_vx in_data 0 20 } } }
}
