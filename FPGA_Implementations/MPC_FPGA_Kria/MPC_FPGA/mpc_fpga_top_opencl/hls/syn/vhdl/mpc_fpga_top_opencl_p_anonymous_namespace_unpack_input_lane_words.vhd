...
entity mpc_fpga_top_opencl_p_anonymous_namespace_unpack_input_lane_words is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mpc_fpga_top_opencl_p_anonymous_namespace_unpack_input_lane_words is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_143 <= input_words512(63 downto 6);
            end if;
        end if;
    end process;
    ...
    begin
        if (((ap_start = ap_const_logic_0) or (m_axi_gmem0_0_ARREADY = ap_const_logic_0))) then 
