...
entity mpc_fpga_top_opencl_p_anonymous_namespace_reset_core_state_hls is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mpc_fpga_top_opencl_p_anonymous_namespace_reset_core_state_hls is 
...
begin
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            p_anonymous_namespace_g_core_state_initialized_ap_vld <= ap_const_logic_1;
        else 
            p_anonymous_namespace_g_core_state_initialized_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            p_anonymous_namespace_g_core_state_persist_actual_steering_ap_vld <= ap_const_logic_1;
        else 
            p_anonymous_namespace_g_core_state_persist_actual_steering_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_anonymous_namespace_g_core_state_persist_max_iter_streak <= ap_const_lv32_0;

    p_anonymous_namespace_g_core_state_persist_max_iter_streak_ap_vld_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            p_anonymous_namespace_g_core_state_persist_max_iter_streak_ap_vld <= ap_const_logic_1;
        else 
            p_anonymous_namespace_g_core_state_persist_max_iter_streak_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            ...
            p_anonymous_namespace_g_core_state_persist_prev_accel_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            ...
            p_anonymous_namespace_g_core_state_persist_prev_curvature_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    p_anonymous_namespace_g_core_state_persist_prev_model_signature <= ap_const_lv1_0;

    p_anonymous_namespace_g_core_state_persist_prev_model_signature_ap_vld_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            p_anonymous_namespace_g_core_state_persist_prev_model_signature_ap_vld <= ap_const_logic_1;
        else 
            p_anonymous_namespace_g_core_state_persist_prev_model_signature_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            ...
            p_anonymous_namespace_g_core_state_persist_prev_steer_rate_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
