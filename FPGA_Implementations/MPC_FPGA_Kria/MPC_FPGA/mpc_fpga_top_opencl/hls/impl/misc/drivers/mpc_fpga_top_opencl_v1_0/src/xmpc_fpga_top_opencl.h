...
// 
// ==============================================================
#ifndef XMPC_FPGA_TOP_OPENCL_H
#define XMPC_FPGA_TOP_OPENCL_H
...
#include <stddef.h>
#endif
#include "xmpc_fpga_top_opencl_hw.h"
...
} XMpc_fpga_top_opencl_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XMpc_fpga_top_opencl;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XMpc_fpga_top_opencl_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XMpc_fpga_top_opencl_ReadReg(BaseAddress, RegOffset) \
