...
#define VP_MAX_ACCEL  FP_QP_CONST(MPC_FPGA_MU * MPC_FPGA_GRAVITY_MS2 * 1.4f)
...
#define WALL_REF_CLEAR_M    FP_QP_CONST(MPC_FPGA_WALL_REF_CLEAR_M)
#define WALL_BOUND_WINDOW   MPC_FPGA_WALL_BOUND_WINDOW

#define ADMM_RHO_MIN FP_QP_CONST(MPC_FPGA_ADMM_RHO_MIN)
#define ADMM_RHO_MAX FP_QP_CONST(MPC_FPGA_ADMM_RHO_MAX)
