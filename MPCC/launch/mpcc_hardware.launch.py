...
HARDWARE_TUNING_DEFAULTS = [
    ("horizon", "HORIZON", "40", "Prediction horizon steps"),
    ("dt", "DT", "0.025", "Prediction time step in seconds"),
    ("q_contouring", "Q_CONTOURING", "40.0", "Contouring weight"),
    ...
    ("wall_clearance_margin", "WALL_CLEARANCE_MARGIN", "0.3", "Soft wall-clearance margin in meters"),
    ...
    ("ax_min", "AX_MIN", "-10.0", "Minimum solver acceleration in m/s^2"),
    ("ax_min_hardware", "MPCC_AX_MIN_HARDWARE", "-10.0", "Hardware braking acceleration clamp in m/s^2"),
    ("r_vtheta", "R_VTHETA", "0.1", "Virtual progress effort weight"),
    ("w_delta_rate", "W_DELTA_RATE", "60.0", "Steering rate weight"),
