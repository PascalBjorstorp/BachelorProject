...
HARDWARE_TUNING_DEFAULTS = [
    ...
    (
        ...
        "Q_WALL_CLEARANCE",
        "3200.0",
        "Soft wall-clearance weight inside the hard corridor",
    ),
    (
        "wall_clearance_margin",
        "WALL_CLEARANCE_MARGIN",
        "0.02",
        "Desired extra wall clearance in meters",
    ),
    (
        "track_buffer",
        "MPCC_TRACK_BUFFER",
        "0.05",
        "Hard buffer subtracted from each track bound in meters",
    ),
    ...
    (
        "accept_max_iterations",
        "MPCC_ACCEPT_MAX_ITER",
        "0",
        "Allow publishing MAX_ITERATIONS solves if residual checks pass (0/1)",
    ),
    (
        "max_iter_primal_tol",
        "MPCC_MAX_ITER_PRIMAL_TOL",
        "0.01",
        "Maximum primal residual allowed when accepting MAX_ITERATIONS",
    ),
    (
        "max_iter_dual_tol",
        "MPCC_MAX_ITER_DUAL_TOL",
        "0.01",
        "Maximum dual residual allowed when accepting MAX_ITERATIONS",
    ),
    (
        "max_iter_track_tol",
        "MPCC_MAX_ITER_TRACK_TOL",
        "0.005",
        "Maximum hard-corridor violation allowed when accepting MAX_ITERATIONS",
    ),
