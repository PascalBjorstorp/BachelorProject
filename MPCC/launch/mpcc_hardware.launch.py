...
HARDWARE_TUNING_DEFAULTS = [
    ("horizon", "HORIZON", "48", "Prediction horizon steps"),
    ("dt", "DT", "0.025", "Prediction time step in seconds"),
    ("q_contouring", "Q_CONTOURING", "15.4", "Contouring weight"),
    ("q_lag", "Q_LAG", "13.4", "Lag weight"),
    ("q_heading", "Q_HEADING", "5.8", "Heading alignment weight"),
    ("q_wall_clearance", "Q_WALL_CLEARANCE", "340.0", "Wall-clearance weight"),
    ("wall_clearance_margin", "WALL_CLEARANCE_MARGIN", "0.10", "Soft wall-clearance margin in meters"),
    ("track_buffer", "MPCC_TRACK_BUFFER", "0.025", "Hard buffer subtracted from each track bound in meters"),
    ("q_progress", "Q_PROGRESS", "0.68", "Progress reward"),
    ...
    ("q_contouring_term", "Q_CONTOURING_TERM", "175.0", "Terminal contouring weight"),
    ("q_lag_term", "Q_LAG_TERM", "135.0", "Terminal lag weight"),
    ("q_heading_term", "Q_HEADING_TERM", "18.0", "Terminal heading alignment weight"),
    ("q_progress_term", "Q_PROGRESS_TERM", "9.3", "Terminal progress reward"),
