...
HARDWARE_TUNING_DEFAULTS = [
    ...
    ("q_vx", "Q_VX", "10.0", "Longitudinal velocity tracking weight"),
    ...
    ("admm_rho_u", "ADMM_RHO_U", "15.0", "Optional control ADMM penalty (0 uses rho)"),
    ("admm_max_iter", "ADMM_MAX_ITER", "300", "ADMM maximum iterations"),
    ("admm_tol", "ADMM_TOL", "0.02", "ADMM convergence tolerance"),
    ("admm_adaptive_rho", "ADMM_ADAPTIVE_RHO", "0", "Enable ADMM adaptive rho updates (0/1)"),
