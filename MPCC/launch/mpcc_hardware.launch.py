...
HARDWARE_TUNING_DEFAULTS = [
    ...
    ("q_lag", "Q_LAG", "5.4", "Lag weight"),
    ("q_heading", "Q_HEADING", "2.8", "Heading alignment weight"),
    ...
    ("r_ax", "R_AX", "0.20", "Acceleration effort weight"),
    ...
    ("w_ax_rate", "W_AX_RATE", "1.5", "Acceleration rate weight"),
