...
export R_AX="${R_AX:-0.05225}"
export R_VTHETA="${R_VTHETA:-0.1}"
export W_DELTA_RATE="${W_DELTA_RATE:-2.0}"
export W_AX_RATE="${W_AX_RATE:-0.488}"
export W_VTHETA_RATE="${W_VTHETA_RATE:-0.1105}"
export Q_CONTOURING_TERM="${Q_CONTOURING_TERM:-4800.0}"
export Q_LAG_TERM="${Q_LAG_TERM:-800.0}"
export Q_PROGRESS_TERM="${Q_PROGRESS_TERM:-41.4}"
export ADMM_RHO="${ADMM_RHO:-5.0}"
export ADMM_MAX_ITER="${ADMM_MAX_ITER:-300}"
export ADMM_TOL="${ADMM_TOL:-0.02}"
export V_THETA_MAX="${V_THETA_MAX:-15.0}"
export CROSS_CALL_SCALE="${CROSS_CALL_SCALE:-0.1}"
