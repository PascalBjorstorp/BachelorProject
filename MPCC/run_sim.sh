...
export DT="${DT:-0.02}"
export Q_CONTOURING="${Q_CONTOURING:-1500.0}"
export Q_LAG="${Q_LAG:-400.0}"
export Q_PROGRESS="${Q_PROGRESS:-40.0}"
export Q_VX="${Q_VX:-30.0}"
export VX_REF="${VX_REF:-4.034304}"
export Q_VY="${Q_VY:-10.0}"
export Q_OMEGA="${Q_OMEGA:-6.0}"
export R_DELTA="${R_DELTA:-130.0}"
