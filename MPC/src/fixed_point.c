...
/* Threshold for tangent overflow protection: 0.1 radians from pi/2 */
/* If angle is within 0.1 rad of ±pi/2, tangent will overflow */
#define TAN_THRESHOLD ((fixed_point_t)6554)  /* 0.1 in Q16.16 ≈ 6554 */
