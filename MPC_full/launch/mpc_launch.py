...
Prerequisites:
  ...
  2. Build this package:
     - colcon build --symlink-install --packages-select mpc_full
"""
...
def generate_launch_description():
    ...
    # Resolve default trajectory path from mpc_full if available
    try:
        from ament_index_python.packages import get_package_share_directory
        mpc_dir = get_package_share_directory('mpc_full')
        ...
        default_trajectory = '/ros2_ws/src/MPC_full/trajectories/my_track_raceline.csv'
